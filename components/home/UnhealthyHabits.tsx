...
const habitPackages: HabitPackage[] = [
  {
    ...
    reportsIn: "6 hours",
    parameters: 30,
    tests: "CBC, ESR, HbA1c, Cholesterol,SGOT, SGPT, Bilirubin, Creatinine, Urea, Vitamin B12",
    price: 1099,
    mrp: 2700,
    discount: "59% Off",
  },
  {
    ...
    reportsIn: "6 hours",
    parameters: 15,
    tests: "CBC, ESR, HbA1c, Cholesterol, SGOT, SGPT, Bilirubin", 
    price: 649,
    mrp: 1600,
    discount: "59% Off",
  },
  {
    ...
    reportsIn: "6 hours",
    parameters: 20,
    tests: "CBC, Bilirubin, CRP, SGOT, SGPT, Urea, Creatinine, Cholesterol, Random Blood Sugar",
    price: 849,
    mrp: 1700,
    discount: "50% Off",
  },
