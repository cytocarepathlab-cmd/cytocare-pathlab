...
export default function Packages({
  ...
  const packages = [
    ...
    },
    {
      ...
      price: "₹1,600",
      tests: ["CBC", "Peripheral Blood Smear", "Retic Count", "CRP", "Iron Profile"],
      reporting: "Same day",
      highlight: false,
    },
    {
      ...
      <div className="mx-auto max-w-[1500px]">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {packages.map((item) => {
            ...
            const visibleTests = isExpanded ? item.tests : item.tests.slice(0, 7);
            ...
            return (
              ...
              >
                {item.highlight && (
                  <p className="mb-5 inline-block rounded-full bg-white px-4 py-2 text-sm font-bold text-[#0754dc]">
                    Whole Body Checkup
                  </p>
                )}
